...
import StudentSubject from "./studentRelated/StudentSubject";
      ...
      <Box sx={{ display: "flex" }}>
        ...
        <Box component="main" sx={styles.boxStyled}>
          ...
          <Routes>
            ...
            <Route
              path="/Admin/subject/student/subject/:studentID/:subjectID"
              element={<StudentSubject situation="Subject" />}
            />
            <Route
            ...
            <Route
              path="/Admin/class/addstudents/:id/:subId"
